...
if 1 <= peso_kg <= 300:
    ...
    print("❌ [RF02] Peso fora do intervalo permitido (1–300 kg)")
...
if 1 <= repeticoes <= 50:
    ...
    print("❌ [RF03] Repetições fora do intervalo permitido (1–50)")
...
#    RF descreve O QUE o sistema deve fazer (funcionalidades).
#    RNF descreve COMO o sistema deve se comportar (qualidade/performance).
#
# 2. O que aconteceria se esquecêssemos o RNF de performance?
#    O sistema poderia funcionar corretamente, mas ser lento,
#    causando má experiência para o usuário e possível abandono do app.
#
# 3. Cite 1 RNF que o GymTrack deveria ter mas que você não implementou
#    Exemplo: O sistema deve suportar pelo menos 10.000 usuários simultâneos.
